...
export const RSP_RESULT_MESSAGES_MAP = new Map<string, string>([
  [RSPGAME_RESULT_OPTIONS.TIE, '¡EMPATE! :/'],
  [RSPGAME_RESULT_OPTIONS.USER_WIN, '¡HAS GANADO! :D'],
  [RSPGAME_RESULT_OPTIONS.COMPUTER_WIN, 'HAS PERDIDO :('],
]);
